...
class AtariEnv(gym.Wrapper):
    """ DeepMind-style Atari Environment """
    def __init__(self, env_name, noop_max=30, skip=4, episode_life=True, 
        warp_frame=True, clip_rewards=False, frame_stack=True, scale=False):
        ...
        super(AtariEnv, self).__init__(env)
